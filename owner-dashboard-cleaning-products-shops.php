    ...
    <div class="container-vinfo text-dark me-4">
      <div class="container mt-3">
        <div class="d-flex align-items-center">
          ...
          <a href="owner-shop-profile-add.php?user_id=<?php echo $user_id; ?>">
            </a>
        </div>
      </div>
        ...
        <div class="row row-cols-1 row-cols-md-1 g-4">
          ...
          if (!empty($shops)) {
            ...
            foreach ($shops as $row) {
              ...
              echo '<a href="owner-dashboard-inventory-cleaning-products.php?shop_id=' . htmlspecialchars($row['shop_id']) . '" class="btn btn-primary">Go to Inventory</a>';
              echo '</div>';
              echo '</div>';
              echo '</div>';
            }
