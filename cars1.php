...
$query = "SELECT * FROM vehicles WHERE id = '$userID'";
                  ...
                  <div class="row">
                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-4 mb-4 mb-xl-4">
                              <div class="card">
                                  <center><div class="card-header text-black"><?php echo isset($_SESSION['firstname']) ? $_SESSION['firstname'] : ''; ?>'s car</div></center>
                          ...
                          <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="label" name="label" disabled>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="platenumber" name="platenumber" disabled>
                              </div>
                              <div class="form-group">
                                  <label for="chassisnumber">Chassis Number:</label>
                                  <input type="text" class="form-control" id="chassisnumber" name="chassisnumber" disabled>
                              </div>
                          </div>
                          ...
                          <div class="col-md-4 mb-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="enginenumber" name="enginenumber" disabled>
                              </div>
                              <div class="form-group">
                            ...
                            <!-- Color, Size, and Edit Button -->
                              ...
                              <a href="csregister_car.php"><button type="button" class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#editModal">Edit your vehicle details</button></a>
                          </div>
                      </div>
                    </div>
                  </div>
