...
<body>
  ...
  ?>
    <main>
        ...
        <form action="cspayment.php" method="get">
          <div class="row">
            <div class="col-md-4">
              ...
              while ($serviceData = mysqli_fetch_assoc($result2)) {
                ...
                if (!empty($serviceData['services'])) {
                  // Explode the imploded services string by the delimiter (assuming ', ' is the delimiter)
                  $servicesArray = explode(', ', $serviceData['services']);
              ...
              // If no data is found, display NA
              if (!$hasData) {
                echo "<p>NA</p>";
              }
              ?>
            ...
            <div class="col-md-4">
              ...
              while ($serviceData = mysqli_fetch_assoc($result2)) {
                // Define how many times you want to duplicate the output
                $duplicateCount = 2; // Change this number to your desired count

                // Loop to duplicate the service duration
      ...
      <a href="cspayment.php?vehicle_id=<?php echo $vehicle_id; ?>&user_id=<?php echo $userID; ?>"><button type="button" class="btn btn-primary ms-5">PROCEED</button></a>
    </main>
  <?php
  } else {
